...
from resources.Category import Category,CatList
...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres@localhost/Store'
...
api.add_resource(CatList,'/category')
api.add_resource(Category,'/category/<string:cname>')
api.add_resource(ProductList,'/products')
api.add_resource(Product,'/products/<string:cname>')
